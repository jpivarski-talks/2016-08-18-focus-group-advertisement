...
\uncover<5->{Results of this study (and other identical sessions) would contribute to a community whitepaper for the NSF's S$^2$I$^2$ project.}
\end{frame}
...
\item Not a file format: {\it in-memory} \mbox{(but very similar to Parquet files).\hspace{-1 cm}}
